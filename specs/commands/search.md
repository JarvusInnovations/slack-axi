...
@alice` → `from:@alice` (messages alice sent), `--with @alice` → `with:@alice` (messages in
conversations that include alice, any sender), `--after 2026-05-01` → `after:2026-05-01`, `--before` →
`before:`.
