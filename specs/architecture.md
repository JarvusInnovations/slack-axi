...
slack-axi/
  ...
  src/
    ...
    commands/
      home.ts  auth.ts  doctor.ts  channels.ts  user.ts  read.ts  search.ts  write.ts  reactions.ts  download.ts  setup.ts
    slack/
      ...
      files.ts                # file metadata off messages + files.info/url_private_download byte fetch
